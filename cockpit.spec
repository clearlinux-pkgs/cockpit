...
Version  : 279
Release  : 141
URL      : https://github.com/cockpit-project/cockpit/releases/download/279/cockpit-279.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/279/cockpit-279.tar.xz
...
%prep
%setup -q -n cockpit-279
cd %{_builddir}/cockpit-279
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667832714
