...
Version  : 293
Release  : 161
URL      : https://github.com/cockpit-project/cockpit/releases/download/293/cockpit-293.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/293/cockpit-293.tar.xz
...
%prep
%setup -q -n cockpit-293
cd %{_builddir}/cockpit-293
%patch1 -p1
%patch2 -p1
pushd ..
cp -a cockpit-293 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685629458
