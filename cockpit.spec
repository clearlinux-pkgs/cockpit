...
Source0  : https://github.com/cockpit-project/cockpit/releases/download/332/cockpit-332.tar.xz
...
%prep
%setup -q -n cockpit-332
cd %{_builddir}/cockpit-332
%patch -P 1 -p1
pushd ..
cp -a cockpit-332 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738166488
