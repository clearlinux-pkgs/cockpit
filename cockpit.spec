...
Source0  : https://github.com/cockpit-project/cockpit/releases/download/339/cockpit-339.tar.xz
...
%prep
%setup -q -n cockpit-339
cd %{_builddir}/cockpit-339
%patch -P 1 -p1
pushd ..
cp -a cockpit-339 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747865622
