...
Version  : 309
Release  : 181
URL      : https://github.com/cockpit-project/cockpit/releases/download/309/cockpit-309.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/309/cockpit-309.tar.xz
...
%prep
%setup -q -n cockpit-309
cd %{_builddir}/cockpit-309
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a cockpit-309 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705700169
