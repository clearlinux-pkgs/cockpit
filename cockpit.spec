...
Source0  : https://github.com/cockpit-project/cockpit/releases/download/328/cockpit-328.tar.xz
...
%prep
%setup -q -n cockpit-328
cd %{_builddir}/cockpit-328
%patch -P 1 -p1
pushd ..
cp -a cockpit-328 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730930761
