...
Version  : 274.1
Release  : 134
URL      : https://github.com/cockpit-project/cockpit/releases/download/274.1/cockpit-274.1.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/274.1/cockpit-274.1.tar.xz
...
%prep
%setup -q -n cockpit-274.1
cd %{_builddir}/cockpit-274.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660056317
