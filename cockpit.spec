...
Version  : 283
Release  : 147
URL      : https://github.com/cockpit-project/cockpit/releases/download/283/cockpit-283.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/283/cockpit-283.tar.xz
...
%prep
%setup -q -n cockpit-283
cd %{_builddir}/cockpit-283
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673535716
