...
Version  : 312
Release  : 188
URL      : https://github.com/cockpit-project/cockpit/releases/download/312/cockpit-312.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/312/cockpit-312.tar.xz
...
%prep
%setup -q -n cockpit-312
cd %{_builddir}/cockpit-312
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a cockpit-312 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709133086
