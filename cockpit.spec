...
Version  : 285
Release  : 149
URL      : https://github.com/cockpit-project/cockpit/releases/download/285/cockpit-285.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/285/cockpit-285.tar.xz
...
%prep
%setup -q -n cockpit-285
cd %{_builddir}/cockpit-285
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675881864
