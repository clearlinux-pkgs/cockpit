...
Source0  : https://github.com/cockpit-project/cockpit/releases/download/314/cockpit-314.tar.xz
...
%prep
%setup -q -n cockpit-314
cd %{_builddir}/cockpit-314
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a cockpit-314 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711636520
