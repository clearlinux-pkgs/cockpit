...
Version  : 308
Release  : 180
URL      : https://github.com/cockpit-project/cockpit/releases/download/308/cockpit-308.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/308/cockpit-308.tar.xz
...
%prep
%setup -q -n cockpit-308
cd %{_builddir}/cockpit-308
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a cockpit-308 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704293932
