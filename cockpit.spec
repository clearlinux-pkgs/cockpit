...
Version  : 281
Release  : 144
URL      : https://github.com/cockpit-project/cockpit/releases/download/281/cockpit-281.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/281/cockpit-281.tar.xz
...
%prep
%setup -q -n cockpit-281
cd %{_builddir}/cockpit-281
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669928474
