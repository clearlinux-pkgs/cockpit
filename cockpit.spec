...
Source0  : https://github.com/cockpit-project/cockpit/releases/download/276/cockpit-276.tar.xz
...
%prep
%setup -q -n cockpit-276
cd %{_builddir}/cockpit-276
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662562860
