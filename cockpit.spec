...
Source0  : https://github.com/cockpit-project/cockpit/releases/download/333/cockpit-333.tar.xz
...
%prep
%setup -q -n cockpit-333
cd %{_builddir}/cockpit-333
%patch -P 1 -p1
pushd ..
cp -a cockpit-333 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739462579
