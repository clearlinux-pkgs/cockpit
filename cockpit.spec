...
Version  : 276.1
Release  : 137
URL      : https://github.com/cockpit-project/cockpit/releases/download/276.1/cockpit-276.1.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/276.1/cockpit-276.1.tar.xz
...
%prep
%setup -q -n cockpit-276.1
cd %{_builddir}/cockpit-276.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662990746
