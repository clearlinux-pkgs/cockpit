...
Source0  : https://github.com/cockpit-project/cockpit/releases/download/342/cockpit-342.tar.xz
...
%prep
%setup -q -n cockpit-342
cd %{_builddir}/cockpit-342
%patch -P 1 -p1
pushd ..
cp -a cockpit-342 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752069200
