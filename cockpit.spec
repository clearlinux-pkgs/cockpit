...
Version  : 278
Release  : 139
URL      : https://github.com/cockpit-project/cockpit/releases/download/278/cockpit-278.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/278/cockpit-278.tar.xz
...
%prep
%setup -q -n cockpit-278
cd %{_builddir}/cockpit-278
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666189845
