...
Source0  : https://github.com/cockpit-project/cockpit/releases/download/305/cockpit-305.tar.xz
...
%prep
%setup -q -n cockpit-305
cd %{_builddir}/cockpit-305
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a cockpit-305 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700060529
