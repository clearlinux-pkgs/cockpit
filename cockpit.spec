...
Version  : 310.1
Release  : 183
URL      : https://github.com/cockpit-project/cockpit/releases/download/310.1/cockpit-310.1.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/310.1/cockpit-310.1.tar.xz
...
%prep
%setup -q -n cockpit-310.1
cd %{_builddir}/cockpit-310.1
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a cockpit-310.1 buildavx2
popd
pushd ..
cp -a cockpit-310.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707144526
...
CXXFLAGS="$CLEAR_INTERMEDIATE_CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 "
LDFLAGS="$CLEAR_INTERMEDIATE_LDFLAGS -march=x86-64-v3 "
%configure  --host=x86_64-clr-linux-gnu  --disable-static --enable-pcp
make  %{?_smp_mflags}
unset CC
popd
%install
...
cp %{_builddir}/cockpit-%{version}/tools/debian/copyright %{buildroot}/usr/share/package-licenses/cockpit/3aa9f0e49648cbbd3b0382796fc7722f10bd1c34 || :
pushd ../buildavx2/
%make_install_v3
popd
pushd ../buildapx/
...
/usr/share/package-licenses/cockpit/3aa9f0e49648cbbd3b0382796fc7722f10bd1c34
