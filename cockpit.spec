...
Version  : 310
Release  : 182
URL      : https://github.com/cockpit-project/cockpit/releases/download/310/cockpit-310.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/310/cockpit-310.tar.xz
...
%prep
%setup -q -n cockpit-310
cd %{_builddir}/cockpit-310
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a cockpit-310 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706715055
