...
Version  : 300
Release  : 169
URL      : https://github.com/cockpit-project/cockpit/releases/download/300/cockpit-300.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/300/cockpit-300.tar.xz
...
%prep
%setup -q -n cockpit-300
cd %{_builddir}/cockpit-300
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a cockpit-300 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694009512
