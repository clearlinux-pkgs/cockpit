...
Version  : 280.1
Release  : 143
URL      : https://github.com/cockpit-project/cockpit/releases/download/280.1/cockpit-280.1.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/280.1/cockpit-280.1.tar.xz
...
%prep
%setup -q -n cockpit-280.1
cd %{_builddir}/cockpit-280.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669391680
