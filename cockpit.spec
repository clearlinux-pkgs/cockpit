...
Version  : 282.1
Release  : 146
URL      : https://github.com/cockpit-project/cockpit/releases/download/282.1/cockpit-282.1.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/282.1/cockpit-282.1.tar.xz
...
%prep
%setup -q -n cockpit-282.1
cd %{_builddir}/cockpit-282.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671635544
...
cp %{_builddir}/cockpit-%{version}/tools/debian/copyright %{buildroot}/usr/share/package-licenses/cockpit/2fb5c69a34f90e58576a8c4f0b867dc36975a6df || :
%make_install
...
/usr/share/package-licenses/cockpit/2fb5c69a34f90e58576a8c4f0b867dc36975a6df
