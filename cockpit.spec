...
Version  : 321
Release  : 193
URL      : https://github.com/cockpit-project/cockpit/releases/download/321/cockpit-321.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/321/cockpit-321.tar.xz
...
%prep
%setup -q -n cockpit-321
cd %{_builddir}/cockpit-321
%patch -P 1 -p1
pushd ..
cp -a cockpit-321 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721847363
...
cp %{_builddir}/cockpit-%{version}/tools/debian/copyright %{buildroot}/usr/share/package-licenses/cockpit/9b8d8dcf3564c4183940209708fe7b1bf79a3390 || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
...
/usr/share/package-licenses/cockpit/9b8d8dcf3564c4183940209708fe7b1bf79a3390
