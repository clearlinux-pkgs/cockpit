...
Version  : 304
Release  : 175
URL      : https://github.com/cockpit-project/cockpit/releases/download/304/cockpit-304.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/304/cockpit-304.tar.xz
...
%prep
%setup -q -n cockpit-304
cd %{_builddir}/cockpit-304
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a cockpit-304 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698848168
...
cp %{_builddir}/cockpit-%{version}/tools/debian/copyright %{buildroot}/usr/share/package-licenses/cockpit/1e05fb8e5e56d2dd1b784ab0b8978ff0299c5f2b || :
pushd ../buildavx2/
%make_install_v3
popd
%make_install
...
/usr/share/package-licenses/cockpit/1e05fb8e5e56d2dd1b784ab0b8978ff0299c5f2b
