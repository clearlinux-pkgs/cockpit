...
Version  : 244.1
Release  : 109
URL      : https://github.com/cockpit-project/cockpit/releases/download/244.1/cockpit-244.1.tar.xz
Source0  : https://github.com/cockpit-project/cockpit/releases/download/244.1/cockpit-244.1.tar.xz
...
%prep
%setup -q -n cockpit-244.1
cd %{_builddir}/cockpit-244.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621263480
...
cp %{_builddir}/cockpit-244.1/COPYING %{buildroot}/usr/share/package-licenses/cockpit/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/cockpit-244.1/COPYING.node %{buildroot}/usr/share/package-licenses/cockpit/b1695f0c4c0487d69d48e0452d27f4477496f671
cp %{_builddir}/cockpit-244.1/node_modules/chrome-remote-interface/LICENSE %{buildroot}/usr/share/package-licenses/cockpit/fa0cf6878d8e23b31412df96f02d9c8453445d4f
cp %{_builddir}/cockpit-244.1/node_modules/chrome-remote-interface/node_modules/commander/LICENSE %{buildroot}/usr/share/package-licenses/cockpit/63513188251d15fcdc716703fbee89be4a3a20e6
cp %{_builddir}/cockpit-244.1/node_modules/commander/LICENSE %{buildroot}/usr/share/package-licenses/cockpit/63513188251d15fcdc716703fbee89be4a3a20e6
cp %{_builddir}/cockpit-244.1/node_modules/sizzle/LICENSE.txt %{buildroot}/usr/share/package-licenses/cockpit/aba8f1f7a4b149e9eec362828f7e8d4bedd68378
cp %{_builddir}/cockpit-244.1/node_modules/ws/LICENSE %{buildroot}/usr/share/package-licenses/cockpit/5267b8c02607adefda571a85283fcd110ae081ba
cp %{_builddir}/cockpit-244.1/src/bridge/mock-resource/system/cockpit/test-priority/sub/COPYING %{buildroot}/usr/share/package-licenses/cockpit/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/cockpit-244.1/src/bridge/mock-resource/system/cockpit/test/sub/COPYING %{buildroot}/usr/share/package-licenses/cockpit/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/cockpit-244.1/tools/debian/copyright %{buildroot}/usr/share/package-licenses/cockpit/10caad1981712744061e21f5be743604a42d29ae
%make_install
%find_lang cockpit
...
/usr/share/package-licenses/cockpit/10caad1981712744061e21f5be743604a42d29ae
...
/usr/share/package-licenses/cockpit/b1695f0c4c0487d69d48e0452d27f4477496f671
