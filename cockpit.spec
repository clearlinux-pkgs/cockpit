...
Source0  : https://github.com/cockpit-project/cockpit/releases/download/313/cockpit-313.tar.xz
...
%prep
%setup -q -n cockpit-313
cd %{_builddir}/cockpit-313
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a cockpit-313 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710534102
